...
function BasketBallShoesDetail() {
  ...
  const productFromUrl =
    ...
    basketballShoes.find((product) => product.heading === selectedHeading)
  const product = clickedProduct || productFromUrl
  const productDetails = basketDetail.find((item) => item.id === product?.id)
  ...
  if (!product) {
    return (
      <div className='mt-30 px-5 text-center'>
        <h1 className='text-3xl font-bold'>Basketball shoe not found</h1>
      </div>
    )
  }
  ...
  return (
    <div className='mt-24 px-4 md:px-10 pb-16 max-w-7xl mx-auto'>
      <DetailNavbar shoeName={product.heading} categoryName="BasketBall" />
      ...
      <div className='p-5 flex flex-col md:flex-row gap-10 items-start justify-between bg-white rounded-2xl border border-gray-200 shadow-sm'>
        ...
        <div className='w-full md:w-1/2 space-y-4'>
          ...
          <div className='rounded-xl border border-blue-200 bg-blue-50/50 p-4 space-y-2 text-xs text-gray-700'>
            ...
            <p><strong>Brand Quality:</strong> {product.brandQuality || 'Pro Court Grip & Ankle Support'}</p>
            <p><strong>Sole Type:</strong> High Traction Rubber Court Sole</p>
            <p><strong>Material:</strong> Durable Leather & Breathable Upper</p>
            <p><strong>Warranty:</strong> 100% Genuine Basketball Footwear Guarantee</p>
          </div>
        </div>
        ...
        <div className='w-full md:w-1/2'>
          ...
          <div className='mt-3 flex items-center gap-2'>
            ...
            <span className='text-xs text-gray-500'>(Pro Player Choice)</span>
          </div>
...
export default BasketBallShoesDetail
